...
export const updateActiveProtocol = createAction<{
  activeProtocol: GovernanceInfo;
}>("/governance/updateActiveProtocol");
export const updateFilterActive = createAction<{ filterActive: boolean }>(
  "/governance/updateFilterActive"
);
export const updateTopDelegates = createAction<{
  protocolID: string;
