...
export const updateTwitterAccount = createAction<{
  twitterAccount: string | undefined;
}>("user/updateTwitterAccount");
export const updateLastSelectedProtocolID = createAction<{
  protocolID: string | undefined;
}>("user/updateLastSelectedProtocolID");
export const toggleURLWarning = createAction<void>("app/toggleURLWarning");

export const updateAmplifiAirdropList = createAction<{ amplifiAirdrop: any }>(
  "app/updateAmplifiAirdropList"
);
