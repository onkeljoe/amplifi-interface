...
console.log(featuredImage)
  return (
    ...
    { featuredImage && // If a featured image exists, display it.
      <img style={{ maxWidth: '600px' }} src={featuredImage.node.mediaItemUrl} alt={featuredImage.altText} className="post-card__image" />
    }
     <a className="post" href={link}> <h3 className="post-card__heading">{title}</h3></a>
